...
package org.wso2.carbon.identity.api.server.organization.user.share.management.common.factory;
    ...
    protected UserSharingPolicyHandlerService createInstance() throws Exception {
        ...
        if (this.userSharingPolicyHandlerService == null) {
            ...
            if (userSharingPolicyHandlerService == null) {
                throw new Exception("Unable to retrieve UserSharingPolicyHandlerService.");
            }
