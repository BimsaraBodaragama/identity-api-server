...
public enum PolicyEnum {
    ...
    @XmlEnumValue("THIS ORG ONLY") ONLY(String.valueOf("THIS ORG ONLY")), @XmlEnumValue("THIS ORG AND ALL CHILDREN OF THIS ORG") AND_ALL_CHILDREN_OF_THIS_ORG(String.valueOf("THIS ORG AND ALL CHILDREN OF THIS ORG")), @XmlEnumValue("THIS ORG AND ALL EXISTING AND FUTURE CHILDREN") AND_ALL_EXISTING_AND_FUTURE_CHILDREN(String.valueOf("THIS ORG AND ALL EXISTING AND FUTURE CHILDREN"));
    ...
    **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(orgId, orgName, sharedUserId, policy, rolesRef);
    }
