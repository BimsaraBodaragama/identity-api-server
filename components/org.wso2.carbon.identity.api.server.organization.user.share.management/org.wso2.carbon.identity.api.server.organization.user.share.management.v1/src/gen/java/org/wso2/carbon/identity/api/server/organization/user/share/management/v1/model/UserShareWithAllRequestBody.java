...
package org.wso2.carbon.identity.api.server.organization.user.share.management.v1.model;
...
import org.wso2.carbon.identity.api.server.organization.user.share.management.v1.model.RoleWithAudience;
import org.wso2.carbon.identity.api.server.organization.user.share.management.v1.model.UserShareRequestBodyUserCriteria;
...
public enum PolicyEnum {
    ...
    @XmlEnumValue("ALL EXISTING ORGS") ALL_EXISTING_ORGS(String.valueOf("ALL EXISTING ORGS")), @XmlEnumValue("ALL EXISTING ORGS AND FUTURE ORGS") ALL_EXISTING_ORGS_AND_FUTURE_ORGS(String.valueOf("ALL EXISTING ORGS AND FUTURE ORGS")), @XmlEnumValue("ONLY EXISTING IMMEDIATE ORGS") ONLY_EXISTING_IMMEDIATE_ORGS(String.valueOf("ONLY EXISTING IMMEDIATE ORGS")), @XmlEnumValue("ONLY EXISTING IMMEDIATE ORGS AND FUTURE IMMEDIATE ORGS") ONLY_EXISTING_IMMEDIATE_ORGS_AND_FUTURE_IMMEDIATE_ORGS(String.valueOf("ONLY EXISTING IMMEDIATE ORGS AND FUTURE IMMEDIATE ORGS"));
